...
int parallelParttion(int* array, int size_, int pivot, int n_npes , int myrank);
...
int main(int argc, char *argv[])
{
	...
	size_ = parallelParttion( array, size_, 7, npes , myrank);
...
int parallelParttion(int* array, int size_, int pivot, int n_npes, int myrank ) {
	...
	int recv_rank = myrank + n_npes/2;
	int send_rank = myrank - n_npes/2;
	int sr_count=0;
